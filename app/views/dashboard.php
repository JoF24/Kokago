...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav ml-auto px-5 nav-underline">
                    <li class="nav-item">
                        <a class="nav-link active navbar-font" aria-current="page" href="<?=BASEURL;?>/beranda/dashboard" >HOME</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="d-flex flex-column denah-cover justify-content-center">
        <div class="d-flex justify-content-center">
    ...
    <div class="d-flex flex-column" style="background-color:#1A120B;height:500px;">
        ...
        <div class="d-flex justify-content-center">
            <a href="<?=BASEURL;?>/beranda/menu" class="btn tombol_menu" role="button"></a>
        </div>
    </div>
