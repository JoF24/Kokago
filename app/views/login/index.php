        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav ml-auto px-5 nav-underline">
                    ...
                    <li class="nav-item">
                        <a class="nav-link navbar-font" href="<?=BASEURL?>/beranda/menu">MENU</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active navbar-font"  aria-current="page" href="<?=BASEURL?>/login/index">LOGIN</a>
                    </li>
                </ul>
            </div>
        </div>
    </nav>
    <div class="d-flex justify-content-center align-items-center background-cover" style="height: 500px;">
        <div class="card" style="width: 500px;height:470px;background-color:#74512D;color:white;">
            <div class="card-body text-center">
                ...
                <form action="<?=BASEURL;?>/login/authenticate" method="post" class="mt-3" style="font-family: 'Times New Roman', Times, serif;">
                    <div class="form-group">
                        ...
                        <input type="text" id="nama" name="nama" class="form-control" style="color: #000;" required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="password" style="font-size: 20px;">Password</label>
                        <input type="password" id="password" name="password" style="color: #000;" class="form-control" required>
                    </div>
                    <button type="submit" class="btn btn-primary mt-4">Login</button>
                </form>
                <div class="d-flex justify-content-center mt-3" style="height: 150px;">
                    <a href="<?=BASEURL;?>/registrasi/index" style="color: #FFFFFF;" >Belum Punya Akun? Klik Disini</a>
                </div>
            </div>
        </div>
    </div>
