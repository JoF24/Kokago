...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav ml-auto px-5 nav-underline">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active navbar-font" aria-current="page"  href="<?= BASEURL;?>/pelanggan/menu">MENU</a>        
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link navbar-font" href="<?= BASEURL;?>/pelanggan/menu#kontak-kami">KONTAK KAMI</a>
                    </li>
    ...
    <div class="d-flex mb-5 mt-3" style="margin-left: 100px;">
        <div class="row w-100">
            <?php 
            if($data['menu']!= null){
                foreach($data['menu'] as $dt): ?>
                    <div class="col-3 mt-3">
                        <div class="card" style="height: 350px; width: 260px;">
                            <img src="<?= BASEURL; ?>/gambar/<?= htmlspecialchars($dt['gambar'], ENT_QUOTES, 'UTF-8'); ?>" style="width: 255px; height: 200px; object-fit: cover;">
                            ...
                            <div class="card align-items-center add-to-cart" data-id="<?= $dt['id_data_menu']; ?>" style="width: 100px; height:30px;margin-left:17px;background-color:blue; cursor:pointer;">
    ...
    <script>
        $(document).ready(function(){
            $('.add-to-cart').click(function(){
                ...
                $.ajax({
                    url: '<?=BASEURL;?>/pelanggan/tambah_keranjang',
                    type: 'POST',
                    data: { 
