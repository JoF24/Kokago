...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav ml-auto px-5 nav-underline">
                    ...
                    <li class="nav-item">
                        <a class="nav-link navbar-font" href="#">MENU</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link navbar-font" href="#">RESERVASI</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link navbar-font" href="#">DENAH KOPKAM</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link navbar-font" href="#">KONTAK KAMI</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="d-flex justify-content-center background-cover">
